...
//         //using the locked key word , we only  allow one piece of code to ever execute
...
// //  you always want to call external contracts as the last step in your function or transaction

// // and we want to update balances to zero 0,  before we call that external function
// // it would hit that require statement and wouldn't be able to send any eth 
